      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Dashboard Artikel</a></li>
            <li><a href="pn_daftar.php"><i class="fa fa-circle-o"></i> Daftar Artikel</a></li>
          </ul>
        </li>
      </ul>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-body">
              <form action="n_artikel.php" method="post">
                <input type="hidden" value="<?php echo $idpenulis?>" name="inpidpenulis">
                <div class="form-group">
                  <label for="inpjdlartikel">Judul Artikel</label>
                  <input type="text" class="form-control" name="inpjdlartikel">
                </div>
                <div class="form-group">
                  <label for="inpisiartikel">Isi Artikel</label>
                  <textarea style="width: 100%" rows="8" name="inpisiartikel"></textarea>
                </div>
