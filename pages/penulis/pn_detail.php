...
//query melihat artikel berdasarkan username
            ...
            <div class="box-body">
              <div class="post">
                <div class="user-block">
                  <span class="username">
                    <a href="#"><?php echo $judulartikel?></a>
                    <a href="d_artikel.php?id=<?php echo $idartikel?>" class="pull-right btn btn-danger"><i class="fa fa-trash"></i></a>
                    <a href="pn_edit.php?id=<?php echo $idartikel?>" class="pull-right btn btn-primary" style="margin-right: 10px"><i class="fa fa-cogs"></i></a>
                  </span>
                ...
                <div class="pull-right">
                  <a href="d_komentar.php?id=<?php echo $datakom['id_komentar']?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>  
                </div>
                <p>
