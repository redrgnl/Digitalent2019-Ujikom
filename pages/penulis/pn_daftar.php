...
$queryartikel = mysqli_query($mysqli, "SELECT * FROM tb_artikel WHERE id_penulis = '$idpenulis' ORDER BY id_artikel DESC");
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="pn_detail.php?id=<?php echo $data['id_artikel']?>" class="btn btn-info"><i class="fa fa-search"></i></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
